...
#define EXAMPLE_PIN_NUM_LCD_SCLK (GPIO_NUM_9)
#define EXAMPLE_PIN_NUM_LCD_MOSI (GPIO_NUM_11)
#define EXAMPLE_PIN_NUM_LCD_RST (GPIO_NUM_13)
#define EXAMPLE_PIN_NUM_BK_LIGHT (GPIO_NUM_15)

#define EXAMPLE_LCD_X_GAP              34
...
static esp_err_t app_lcd_init(void)
{
   ...
   const spi_bus_config_t buscfg = JD9853_PANEL_BUS_SPI_CONFIG(EXAMPLE_PIN_NUM_LCD_SCLK,
